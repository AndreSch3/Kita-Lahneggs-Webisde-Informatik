/* JS Cookies Pop up Konfiguration*/
/* This one i didn't type on my own. It was a finished code for cookies*/
    ...
    if (!e.hasInitialised) {
            ...
            return (
                (o.prototype.initialise = function(
                    ...
                    this.options &&
                        ...
                        function() {
                            var t = this.options.onInitialise.bind(
                                this
                            );
                            if (!window
                                .navigator
                ...
                (o.prototype.toggleRevokeButton = function(
                    e
                ) {
                    this.revokeBtn &&
                        (this.revokeBtn.style.display = e ?
                            "" :
                            "none");
                }),
                (o.prototype.revokeChoice = function(
                    e
                ) {
                    (this.options.enabled = !0),
                    this.clearStatus(),
                        this.options.onRevokeChoice.call(
                            this
                        ),
                        e ||
                        this.autoOpen();
                ...
                (o.prototype.setStatus = function(
                    i
                ) {
                    var n = this
                        .options
        ...
        (e.Location = (function() {
            ...
            return (
                ...
                (i.prototype.getServiceByIdx = function(
                    e
                ) {
                    var i = this
                        .options
                ...
                (i.prototype.runService = function(
                    e,
                    t
                ) {
                    var i = this;
                ...
                (i.prototype.runServiceCallback = function(
                    e,
                    t,
                    i
                ) {
                ...
                (i.prototype.onServiceResult = function(
                    e,
                    t
                ) {
                    t instanceof
                ...
                (i.prototype.runNextServiceOnError = function(
                    e,
                    t
                ) {
                    if (e) {
                ...
                (i.prototype.completeService = function(
                    e,
                    t
                ) {
                    (this.currentServiceIndex = -1),
                ...
                (i.prototype.logError = function(
                    e
                ) {
                    var t = this
                        .currentServiceIndex,
                        i = this.getServiceByIdx(
                            t
                        );
                    console.warn(
                        "The service[" +
            ...
            return (
                ...
                (i.prototype.get = function(
                    ...
                    var t = this
                        .options;
                    return {
                        hasLaw: t.hasLaw.indexOf(
                            e
                        ) >= 0,
                        revokable: t.revokable.indexOf(
                            e
                        ) >= 0,
                        explicitAction: t.explicitAction.indexOf(
                            e
                        ) >= 0,
                    };
                }),
                (i.prototype.applyLaw = function(
                    e,
                    t
                ) {
                    var i = this.get(
